...
async function seed() {
  console.log("Seeding Mazunte Now...");

  // ── Venues ──────────────────────────────────────────
  const venueData = [
    { name: "Hridaya Yoga Center", description: "Yoga & meditation retreat center", address: "Ctra. Mazunte – San Agustinillo", latitude: "15.66693", longitude: "-96.54829", website: "https://hridaya-yoga.com" },
    { name: "Akasha", description: "Multi-purpose wellness space", address: "Main Road, Mazunte" },
    { name: "La Cosmica", description: "Event and wellness space", address: "Mazunte Center" },
    { name: "Temascal Ocelotl", description: "Traditional temazcal ceremony space", address: "Mazunte" },
    { name: "Punta Cometa", description: "Sacred hilltop sunset point", address: "Accessible from Camino Mermejita", latitude: "15.6620", longitude: "-96.3480" },
    { name: "Playa Mermejita", description: "Quiet beach west of town", address: "15-minute walk west from center" },
    { name: "Main Plaza", description: "Town center gathering spot", address: "Mazunte Center" },
    { name: "La Choripaneria", description: "Argentine choripan spot", address: "Mazunte" },
    { name: "Cocomiel", description: "Cafe and brunch spot", address: "Mazunte" },
    { name: "Rancho Cerro Largo", description: "Donation-based yoga center", address: "Mazunte" },
    { name: "Solstice Yoga Center", description: "Community-based drop-in yoga classes", address: "Mazunte Center" },
    { name: "Posada del Arquitecto", description: "Yoga & wellness hub", address: "Main Street, Mazunte" },
  ];

  const venues = venueData.map((v) => ({
    id: createId(),
    name: v.name,
    slug: slugify(v.name),
  ...
  const oneOffEvents = [
    ...
    },
    {
      ...
      venueId: venueMap["Playa Mermejita"],
      date: today,
      startTime: "08:30:00",
      endTime: "10:00:00",
    ...
    },
    {
      ...
      venueId: venueMap["Temascal Ocelotl"],
      date: today,
      startTime: "16:00:00",
      endTime: "18:00:00",
    ...
    },
    {
      ...
      venueId: venueMap["Hridaya Yoga Center"],
      date: today,
      startTime: "17:30:00",
      endTime: "19:00:00",
    ...
    },
    {
      ...
      venueId: venueMap["La Choripaneria"],
      date: today,
      startTime: "19:00:00",
      endTime: "22:00:00",
    ...
    },
    {
      ...
      venueId: venueMap["Posada del Arquitecto"],
      date: dayAfter,
      startTime: "10:00:00",
      endTime: "12:00:00",
  ...
  const recurringEvent = {
    ...
    category: "yoga" as const,
    venueId: venueMap["Rancho Cerro Largo"],
